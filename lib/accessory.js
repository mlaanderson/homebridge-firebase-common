...
function Accessory(ref) {
    ...
    Object.defineProperty(this, 'PrimaryService', {
        get: function() {
            if (_ready) {
                if ((this._serviceNames.indexOf('AccessoryInformation') == 0) && (this._serviceNames.length > 1)) {
    ...
    Object.defineProperty(this, 'PrimaryServiceName', {
        get: function() {
            if (_ready) {
                if ((this._services.indexOf('AccessoryInformation') == 0) && (this._serviceNames.length > 1)) {
                    return this._serviceNames[1];
                }
                return this._serviceNames[0];
            }
            return undefined;
        }
    });
